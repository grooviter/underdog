...
.Note
****
This getting started section mimics the link:https://ta4j.github.io/ta4j-wiki/Getting-started.html[getting started] section steps from link:https://ta4j.github.io/ta4j-wiki/[Ta4j wiki] but using underdog-ta module. You can compare both entries to see the differences.
****
