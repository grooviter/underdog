...
image::graphs/tutorial_adding_vertices.png[align=center]
...
image::graphs/tutorial_adding_edges.png[align=center]
...
image::graphs/tutorial_adding_edges_II.png[align=center]
...
.graph
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph,indent=0]
----
...
.shape
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_shape,indent=0]
----
...
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_clustering_global,indent=0]
----
...
.clustering average
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_clustering_avg,indent=0]
----
...
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_clustering_vertex,indent=0]
----
...
.max degree
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_max_degree,indent=0]
----
...
----
include::{sources}/TutorialSpec.groovy[tag=analyzing_graph_sort_by_degree,indent=0]
----