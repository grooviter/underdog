=== Tutorial
:sources: ../../../../../../modules/underdog-dataframe/src/test/groovy
...
.reading csv
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=read_csv,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=columns,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=shape,indent=0]
----

[source, groovy]
.shape of the dataframe
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=shape2,indent=0]
----
...
.tornadoes schemas
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=schema,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=schema_tune,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=first,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=mapping,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=add_series,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=remove_series,indent=0]
----
...
.sort asc
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=sorting_1,indent=0]
----
...
.sort desc
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=sorting_2,indent=0]
----
...
.sort by n-fields
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=sorting_3,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=column_describe,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=filtering,indent=0]
----
...
[source, groovy]
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=summarizing,indent=0]
----
...
.crosstabs (count)
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=crosstabs,indent=0]
----
...
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=summer,indent=0]
----
...
.lag and delta dates
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=summer_lag,indent=0]
----
...
.create summary
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=summary,indent=0]
----
...
[source, groovy]
----
include::{sources}/com/github/grooviter/underdog/samples/TornadosSpec.groovy[tag=mean_of_series,indent=0]
----
