...
class CreditApprovalSpec extends Specification {
    static String CREDIT_CSV = "src/test/resources/com/github/grooviter/underdog/tablesaw/german.data"
    ...
    DataFrame loadDataFrame() {
        return Underdog
            .read_csv(path: CREDIT_CSV, sep: " ", allowedDuplicatedNames: true)
