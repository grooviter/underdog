...
class FirewallDetectionSpec extends Specification {
    static String CSV_PATH = "src/test/resources/com/github/grooviter/underdog/tablesaw/firewall.csv"
    ...
    def loadData() {
        return Underdog.read_csv(path: CSV_PATH).rename(columns: COLUMNS).dropna()
    }
