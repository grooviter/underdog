...
class Assignment3Spec extends Specification{
    static EXCEL_ENERGY = "src/test/resources/com/github/grooviter/underdog/examples/Energy Indicators.xls"
    static CSV_WORLD_BANK = "src/test/resources/com/github/grooviter/underdog/examples/world_bank.csv"
    static CSV_SCIMAGO = "src/test/resources/com/github/grooviter/underdog/examples/scimagojr-3.xlsx"
