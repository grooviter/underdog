...
import com.github.grooviter.underdog.smile.nlp.DefaultStopWords
import com.github.grooviter.underdog.smile.nlp.TFidf
...
class NLPExtensions {
    ...
    static double[][] vectorized(String[] sentences) {
        return Smile.features.countVectorizer().fitTransform(sentences)
    }
