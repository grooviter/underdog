...
class TornadosSpec extends Specification {
    def "metadata"() {
        setup:
        // tag::read_csv[]
        def tornadoes = Underdog.read_csv(this.class.getResource("tornadoes_1950-2014.csv").file)
        // end::read_csv[]
    ...
    def "filtering"() {
        ...
        // reading tornadoes
        def ts = Underdog.read_csv(this.class.getResource("tornadoes_1950-2014.csv").file)
